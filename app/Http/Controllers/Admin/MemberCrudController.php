...
class MemberCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->removeColumns(['image', 'signature']); // remove an array of columns from the stack
        //$this->crud->setColumnDetails('status', ['attribute' => 'value']); // adjusts the properties of the passed in column (by name)
        // $this->crud->setColumnsDetails(['column_1', 'column_2'], ['attribute' => 'value']);

        // ------ CRUD BUTTONS
        // possible positions: 'beginning' and 'end'; defaults to 'beginning' for the 'line' stack, 'end' for the others;
        //$this->crud->addButton('line', 'Show', 'view', 'show','beginning'); // add a button; possible types are: view, model_function
