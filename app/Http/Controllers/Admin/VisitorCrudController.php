...
use App\Http\Requests\VisitorRequest as StoreRequest;
use App\Http\Requests\VisitorRequest as UpdateRequest;
    ...
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addColumn([
            ...
            'label' => "Visitors Image", // Table column heading
            'type' => 'image',
        ...
        $this->crud->addColumn([
            'label' => "Department to Visit", // Table column heading
            'type' => "select",
