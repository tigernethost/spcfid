...
def print_events(device):
        ...
        buf = ''
        is_in = 0
        #status_in = {"rfid":format(buf), "is_in":0, "turnstile_no": turnstile_no}
        #p_status_in = pickle.dumps(status_in)
        #r.set('status_in',p_status_in)

        #status_out = {"rfid":format(buf), "is_out":0, "turnstile_no": turnstile_no}
        #p_status_out = pickle.dumps(status_out)
        #r.set('status_out',p_status_out)
